      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <input
            ...
            className={`w-full px-4 py-3 rounded-lg border bg-gray-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 focus:bg-gray-700 transition-all duration-200 font-medium ${errors.email ? 'border-red-500 bg-red-900/20' : 'border-gray-600 hover:border-gray-500'
              }`}
        ...
        <div>
          <div className="relative">
            <input
              ...
              className={`w-full px-4 py-3 pr-12 rounded-lg border bg-gray-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 focus:bg-gray-700 transition-all duration-200 font-medium ${errors.password ? 'border-red-500 bg-red-900/20' : 'border-gray-600 hover:border-gray-500'
                }`}
