...
export function Sidebar({ role }: SidebarProps) {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex h-screen w-64 flex-col bg-[#2D0A0A] border-r border-[#450A0A]/30 transition-transform duration-300 md:relative md:translate-x-0",
