...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-gray-900 flex pt-16">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-gray-900 min-h-[calc(100vh-4rem)]">
          ...
          <div className="text-center max-w-md">
            ...
            <div className="mt-8 space-y-2">
              <div className="flex items-center justify-center space-x-2">
                ...
                <span className="text-gray-200">Acceso a tus rutinas</span>
              </div>
              <div className="flex items-center justify-center space-x-2">
                <svg className="w-5 h-5 text-red-400" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              ...
              <div className="flex items-center justify-center space-x-2">
                ...
                <span className="text-gray-200">Comunidad fitness</span>
              </div>
            </div>
          </div>
        </div>
